            ...
            >
                <div className="flex justify-between items-center p-8 border-b border-slate-50 bg-slate-50/50">
                    <div>
                        ...
                        <p className="text-slate-400 text-xs font-bold uppercase tracking-widest mt-2 ml-10">กรอกข้อมูลงานให้ครบถ้วนเพื่อเริ่มการติดตาม</p>
                    </div>
                    <button onClick={onClose} className="bg-white text-slate-400 hover:text-rose-500 p-3 rounded-2xl border border-slate-100 shadow-sm transition-all hover:border-rose-100 hover:bg-rose-50 active:scale-95">
                        <X className="w-6 h-6" />
                    </button>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="md:col-span-2">
                            <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2.5 ml-1">ชื่อผู้ว่าจ้าง / Account</label>
                            <div className="relative group">
                                ...
                                <input
                                    required
                                    type="text"
                                    className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-2xl outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 focus:bg-white text-sm font-bold transition-all placeholder:text-slate-300 shadow-inner"
                        ...
                        <div>
                            <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2.5 ml-1">ลิงก์ติดต่อ (แชท)</label>
                            <div className="relative group">
                        ...
                        <div>
                            <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2.5 ml-1">ลิงก์งาน (Target URL)</label>
                            <div className="relative group">
                        ...
                        <div>
                            <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2.5 ml-1">แพลตฟอร์ม</label>
                            <div className="relative group">
                                ...
                                <select
                                    className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-2xl outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 focus:bg-white text-sm font-bold transition-all appearance-none cursor-pointer shadow-inner"
                        ...
                        <div>
                            <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2.5 ml-1">บริการ (Service Type)</label>
                            <div className="relative group">
                        ...
                        <div>
                            <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2.5 ml-1">ยอดรวมที่สั่ง (Total Amount)</label>
                            <div className="relative group">
                        ...
                        <div>
                            <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2.5 ml-1">วันที่เริ่ม (Start Date)</label>
                            <div className="relative group">
                                ...
                                <input
                                    required
                                    type="datetime-local"
                                    className="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-2xl outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 focus:bg-white text-sm font-bold transition-all shadow-inner"
                        ...
                        <div>
                            <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-2.5 ml-1 text-rose-400">กำหนดส่ง (Deadline)</label>
                            <div className="relative group">
